...
public class PeopleCostActivity extends BaseActivity {
    ...
    private void showPopWindow() {
        ...
        View rootView=LayoutInflater.from(PeopleCostActivity.this).inflate(R.layout.activity_costpeople,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                @SuppressLint("InflateParams") View rootView= LayoutInflater.from(PeopleCostActivity.this).inflate(R.layout.activity_reduce_fish_add,null);
