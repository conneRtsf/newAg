...
import com.example.newag.mvp.ui.change.OtherCost;
import com.example.newag.mvp.ui.costs.OtherCostActivity;
...
public class FishPeriodActivity extends BaseActivity {
    ...
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(FishPeriodActivity.this, OtherPeriodActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(FishPeriodActivity.this, PeriodPlus.class);
        startActivity(intent);
    }
    ...
    private void showPopWindow(AllText allText,int position) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(FishPeriodActivity.this, FishPeriod.class);
