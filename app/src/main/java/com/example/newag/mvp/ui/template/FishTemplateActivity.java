...
import com.example.newag.mvp.ui.change.FishTemplate;
...
public class FishTemplateActivity extends BaseActivity {
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(FishTemplateActivity.this).inflate(R.layout.pop_plustemplate, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(FishTemplateActivity.this, FishTemplate.class);
