...
public class FishPeriod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(FishPeriod.this,  2, btnDate, calendar);;
            }
        });
        initText();//为原始数据添加数据
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(FishPeriod.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(FishPeriod.this).inflate(R.layout.period_fish,null);
        ...
        View view2=LayoutInflater.from(FishPeriod.this).inflate(R.layout.popwindowdelete,null);
