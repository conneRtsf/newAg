...
import com.example.newag.mvp.ui.plus.record_plus;
...
public class Feeding_record extends AppCompatActivity {
    Button ce1;
    Button ce2;
    Button plus;
    Button tb1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(Feeding_record.this,  2, btnDate, calendar);;
            }
        });
        ce1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(Feeding_record.this, program_add.class);
        ...
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(Feeding_record.this, record_plus.class);
                startActivity(intent);
            }
        });
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(Feeding_record.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(Feeding_record.this).inflate(R.layout.program_record,null);
        ...
        View view2=LayoutInflater.from(Feeding_record.this).inflate(R.layout.popwindowdelete,null);
