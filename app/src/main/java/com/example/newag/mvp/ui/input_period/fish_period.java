...
public class fish_period extends AppCompatActivity {
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(fish_period.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(fish_period.this).inflate(R.layout.period_fish,null);
        ...
        View view2=LayoutInflater.from(fish_period.this).inflate(R.layout.popwindowdelete,null);
