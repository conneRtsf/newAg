...
import com.example.newag.mvp.ui.change.AdultFishStorkChangeActivity;
import com.example.newag.mvp.ui.change.AdultVegetableStorkChangeActivity;
...
import com.example.newag.mvp.ui.plus.StorkAdultVegetablePlusActivity;
...
public class AdultVegetableStockActivity extends BaseActivity {
    ...
    void onClick1(View view) {
        ...
        intent.setClass(AdultVegetableStockActivity.this, DrugStockActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultVegetableStockActivity.this, FeedStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultVegetableStockActivity.this, FishStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultVegetableStockActivity.this, VegetableStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultVegetableStockActivity.this, OtherStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce6)
    void onClick6(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultVegetableStockActivity.this, AdultFishStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce7)
    void onClick7(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultVegetableStockActivity.this, AdultVegetableStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultVegetableStockActivity.this, StorkAdultVegetablePlusActivity.class);
        startActivity(intent);
    }
    @BindView(R.id.root)
    DrawerLayout root;
    ...
    protected void baseConfigView() {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                AdultVegetableStockActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View rootView;
                View view2=LayoutInflater.from(AdultVegetableStockActivity.this).inflate(R.layout.ppw_delete,null);
                ...
                adapter.notifyDataSetChanged();
                rootView= LayoutInflater.from(AdultVegetableStockActivity.this).inflate(R.layout.activity_reduce_field_add,null);
                                ...
                                public void run() {
                                    try {
                                        ...
                                        AdultVegetableStockActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(AdultVegetableStockActivity.this, fd,Toast.LENGTH_SHORT).show();
                                                adapter.notifyDataSetChanged();
                                            }
                                        });
    ...
    protected int layoutId() {
        return R.layout.activity_adult_vegetable_stock;
    }
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(AdultVegetableStockActivity.this).inflate(R.layout.pop_plustemplate, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(AdultVegetableStockActivity.this, AdultVegetableStorkChangeActivity.class);
                ...
                try {
                    ...
                    for (Map.Entry<String, JsonArray> entry : map.entrySet()) {
                        ...
                        if(mid.equals("adultvegetable")) {
                            data_1.add(new AllTextMaster("蔬菜（修改库存数量请长按）", allTextList1));
                        }
                    }
                }catch (Exception e){
                    e.printStackTrace();
