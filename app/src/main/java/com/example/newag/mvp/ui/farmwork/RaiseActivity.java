...
public class RaiseActivity extends BaseActivity {
    ...
    void onClick1(View view) {
        ...
        intent.setClass(RaiseActivity.this, RaisePlusActivity.class);
        startActivity(intent);
    }
    @OnClick(R.id.ce1)
    void click3(){
        Intent intent = new Intent();
        intent.setClass(RaiseActivity.this, SowingActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce2)
    void click1(){
        Intent intent = new Intent();
        intent.setClass(RaiseActivity.this, HarvestFishingActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void click2(){
        Intent intent = new Intent();
        intent.setClass(RaiseActivity.this, MedicationActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void click4(){
        Intent intent = new Intent();
        intent.setClass(RaiseActivity.this, RaiseActivity.class);
        startActivity(intent);
        finish();
    }
    @BindView(R.id.root)
    ...
    protected void baseConfigView() {
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(RaiseActivity.this,  2, btnDate, calendar);;
            }
        });
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View rootView;
                View view2= LayoutInflater.from(RaiseActivity.this).inflate(R.layout.ppw_delete,null);
                ...
                rootView= LayoutInflater.from(RaiseActivity.this).inflate(R.layout.activity_raise,null);
                ...
                button_cancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        data_1.clear();
                        postSync();
                        RaiseActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                adapter.notifyDataSetChanged();
                            }
                                ...
                                public void run() {
                                    try {
                                        ...
                                        RaiseActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(RaiseActivity.this, fd,Toast.LENGTH_SHORT).show();
                                                adapter.notifyDataSetChanged();
                                            }
                                        });
        ...
        new DatePickerDialog(activity, themeResId, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                RaiseActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(RaiseActivity.this, "刷新以重新获取全部数据", Toast.LENGTH_SHORT).show();
                    }
                });
