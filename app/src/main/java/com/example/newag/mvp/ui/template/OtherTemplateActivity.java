...
import com.example.newag.mvp.ui.change.OtherTemplate;
...
public class OtherTemplateActivity extends BaseActivity {
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(OtherTemplateActivity.this).inflate(R.layout.pop_plustemplate, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(OtherTemplateActivity.this, OtherTemplate.class);
