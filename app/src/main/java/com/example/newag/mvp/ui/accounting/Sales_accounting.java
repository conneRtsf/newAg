...
public class Sales_accounting extends AppCompatActivity {
    public Button plus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(Sales_accounting.this,  2, btnDate, calendar);;
            }
        });
...
//        dialogWindow.setWindowAnimations(R.style.dialogstyle); // 添加动画
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(Sales_accounting.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(Sales_accounting.this).inflate(R.layout.accounting,null);
        ...
        View view2=LayoutInflater.from(Sales_accounting.this).inflate(R.layout.popwindowdelete,null);
