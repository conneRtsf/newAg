...
public class DrugTemplateActivity extends AppCompatActivity {
    @OnClick(R.id.tb1)
    ...
    void onClick1(View view) {
        ...
        intent.setClass(DrugTemplateActivity.this, DrugTemplateActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugTemplateActivity.this, FeedTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugTemplateActivity.this, FishTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugTemplateActivity.this, VegetableTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugTemplateActivity.this, OtherTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugTemplateActivity.this, TemplatePlus.class);
        startActivity(intent);
    }
    @BindView(R.id.root)
    DrawerLayout root;
    ...
    private void showPopWindow() {
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(DrugTemplateActivity.this).inflate(R.layout.activity_templatedrug,null);
        ...
        View view2=LayoutInflater.from(DrugTemplateActivity.this).inflate(R.layout.ppw_delete,null);
