...
//        dialogWindow.setWindowAnimations(R.style.dialogstyle); // 添加动画
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(OtherCostActivity.this).inflate(R.layout.pop_pluspeople, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(OtherCostActivity.this, OtherCost.class);
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(OtherCostActivity.this).inflate(R.layout.footer_batch,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(OtherCostActivity.this).inflate(R.layout.activity_costother,null);
