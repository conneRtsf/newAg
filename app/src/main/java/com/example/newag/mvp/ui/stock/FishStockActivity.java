...
public class FishStockActivity extends BaseActivity {
    ...
    void onClick1(View view) {
        ...
        intent.setClass(FishStockActivity.this, DrugStockActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(FishStockActivity.this, FeedStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(FishStockActivity.this, FishStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(FishStockActivity.this, VegetableStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(FishStockActivity.this, OtherStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce6)
    ...
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(FishStockActivity.this, StorkFishPlusActivity.class);
        startActivity(intent);
    }
    @BindView(R.id.root)
    DrawerLayout root;
    ...
    private void showPopWindow(AllText allText,int position) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(FishStockActivity.this, FishStorkChangeActivity.class);
