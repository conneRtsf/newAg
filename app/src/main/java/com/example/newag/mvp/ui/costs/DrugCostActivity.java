...
import com.example.newag.mvp.ui.plus.CostDrugPlusActivity;
import com.example.newag.mvp.ui.plus.CostFishPlusActivity;
...
public class DrugCostActivity extends BaseActivity {
    @OnClick(R.id.tb1)
    ...
    void onClick1(View view) {
        ...
        intent.setClass(DrugCostActivity.this, PeopleCostActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugCostActivity.this, FeedCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugCostActivity.this, EnergyCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugCostActivity.this, FishCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugCostActivity.this, VegetableCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce6)
    void onClick6(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugCostActivity.this, OtherCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce7)
    void onClick7(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugCostActivity.this, AllCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(DrugCostActivity.this, CostDrugPlusActivity.class);
        startActivity(intent);
    }
    ...
    protected void baseConfigView() {
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(DrugCostActivity.this,  2, btnDate, calendar);
            }
        });
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View rootView;
                View view2=LayoutInflater.from(DrugCostActivity.this).inflate(R.layout.ppw_delete,null);
                ...
                rootView= LayoutInflater.from(DrugCostActivity.this).inflate(R.layout.activity_drug_cost,null);
                ...
                button_cancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        data_1.clear();
                        postSync();
                        DrugCostActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                adapter.notifyDataSetChanged();
                            }
                                ...
                                public void run() {
                                    try {
                                        ...
                                        DrugCostActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(DrugCostActivity.this, fd,Toast.LENGTH_SHORT).show();
                                                adapter.notifyDataSetChanged();
                                            }
                                        });
    ...
    protected int layoutId() {
        return R.layout.activity_costfish;
    }
        ...
        new DatePickerDialog(activity, themeResId, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                DrugCostActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(DrugCostActivity.this, "刷新以重新获取全部数据", Toast.LENGTH_SHORT).show();
                    }
                });
                OkHttpClient httpClient = new OkHttpClient.Builder()
