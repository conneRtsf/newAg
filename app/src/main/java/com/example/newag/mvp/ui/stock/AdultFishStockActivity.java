...
public class AdultFishStockActivity extends BaseActivity {
    ...
    void onClick1(View view) {
        ...
        intent.setClass(AdultFishStockActivity.this, DrugStockActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultFishStockActivity.this, FeedStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultFishStockActivity.this, FishStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultFishStockActivity.this, VegetableStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultFishStockActivity.this, OtherStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce6)
    void onClick6(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultFishStockActivity.this, AdultFishStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce7)
    void onClick7(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultFishStockActivity.this, AdultVegetableStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(AdultFishStockActivity.this, StorkAdultFishPlusActivity.class);
        startActivity(intent);
    }
    @BindView(R.id.root)
    DrawerLayout root;
    ...
    protected void baseConfigView() {
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View rootView;
                View view2=LayoutInflater.from(AdultFishStockActivity.this).inflate(R.layout.ppw_delete,null);
                ...
                adapter.notifyDataSetChanged();
                rootView= LayoutInflater.from(AdultFishStockActivity.this).inflate(R.layout.activity_reduce_field_add,null);
                                ...
                                public void run() {
                                    try {
                                        ...
                                        AdultFishStockActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(AdultFishStockActivity.this, fd,Toast.LENGTH_SHORT).show();
                                                adapter.notifyDataSetChanged();
                                            }
                                        });
    ...
    protected int layoutId() {
        return R.layout.activity_adult_fish;
    }
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(AdultFishStockActivity.this).inflate(R.layout.pop_plustemplate, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(AdultFishStockActivity.this, AdultFishStorkChangeActivity.class);
