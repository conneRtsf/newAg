...
public class FishPeriodChangeActivity extends BaseActivity {
    @OnClick(R.id.commit)
    public void cl(){
    ...
    protected void baseConfigView() {
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(FishPeriodChangeActivity.this,  2, btnDate, calendar);;
            }
        });
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    FishPeriodChangeActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            adapter = new ArrayAdapter<CharSequence>(FishPeriodChangeActivity.this,android.R.layout.simple_spinner_item, finalMidS);
                            produce.setAdapter(adapter);
                            produce.setOnItemSelectedListener(new FishPeriodChangeActivity.OnItemSelectedListenerImpl1());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
                ...
                try {
                    ...
                    FishPeriodChangeActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            plan.setOnItemSelectedListener(new FishPeriodChangeActivity.OnItemSelectedListenerImpl2());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
                ...
                try {
                    ...
                    FishPeriodChangeActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            nameId.setOnItemSelectedListener(new FishPeriodChangeActivity.OnItemSelectedListenerImpl3());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                new Thread(() -> {
                    try {
                        ...
                        Toast.makeText(FishPeriodChangeActivity.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        if(jsonObject1.getString("msg").equals("插入成功")){
                            FishPeriodChangeActivity.this.finish();
                        }
                        Looper.loop();
