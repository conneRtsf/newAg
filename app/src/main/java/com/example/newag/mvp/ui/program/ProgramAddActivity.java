...
import com.example.newag.mvp.ui.costs.FeedCostActivity;
...
public class ProgramAddActivity extends BaseActivity {
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(ProgramAddActivity.this).inflate(R.layout.pop_plusprogram, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(ProgramAddActivity.this, ProgramAdd.class);
