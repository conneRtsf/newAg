...
public class VegetablePeriod extends AppCompatActivity {
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(VegetablePeriod.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(VegetablePeriod.this).inflate(R.layout.template_vegetable,null);
        ...
        View rootView=LayoutInflater.from(VegetablePeriod.this).inflate(R.layout.period_vegetable,null);
        popupWindow.showAtLocation(rootView, Gravity.BOTTOM,0,0);//展示自定义的popwindow，（放哪个布局里，放布局里的位置，x，y），cv工程
        View view2=LayoutInflater.from(VegetablePeriod.this).inflate(R.layout.popwindowdelete,null);
