...
public class vegetable_cost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(vegetable_cost.this,  2, btnDate, calendar);
            }
        });
        initText();//为原始数据添加数据
        ...
        ce1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(vegetable_cost.this, people_cost.class);
        ...
        ce2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(vegetable_cost.this, feed_cost.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ce3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(vegetable_cost.this, energy_cost.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ce4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(vegetable_cost.this, fish_cost.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ce7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(vegetable_cost.this, all_cost.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(vegetable_cost.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(vegetable_cost.this).inflate(R.layout.cost_vegetable,null);
        ...
        View view2=LayoutInflater.from(vegetable_cost.this).inflate(R.layout.popwindowdelete,null);
