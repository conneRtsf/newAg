...
import com.example.newag.mvp.ui.change.FeedTemplate;
...
public class FeedTemplateActivity extends BaseActivity {
    ...
    void onClick1(View view) {
        ...
        intent.setClass(FeedTemplateActivity.this, DrugTemplateActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(FeedTemplateActivity.this, FeedTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(FeedTemplateActivity.this, FishTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(FeedTemplateActivity.this, VegetableTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(FeedTemplateActivity.this, OtherTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(FeedTemplateActivity.this, TemplatePlus.class);
        startActivity(intent);
    }
    @BindView(R.id.root)
    DrawerLayout root;
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(FeedTemplateActivity.this).inflate(R.layout.pop_plustemplate, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(FeedTemplateActivity.this, FeedTemplate.class);
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(FeedTemplateActivity.this).inflate(R.layout.footer_batch,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(FeedTemplateActivity.this).inflate(R.layout.activity_templatefeed,null);
        ...
        View view2=LayoutInflater.from(FeedTemplateActivity.this).inflate(R.layout.ppw_delete,null);
    ...
    private void initText() {
        ...
        data_1.add(add2);
        //
        AllText one1=new AllText("1.饲料投入1 a厂商");
        allTextList11.add(one1);
        AllText two2=new AllText("2.饲料投入2 b厂商");
        allTextList11.add(two2);
        AllText three3=new AllText("3.饲料投入3 c厂商");
        allTextList11.add(three3);
        AllTextMaster add11=new AllTextMaster("饲料模板",allTextList11);
        AllText one2=new AllText("4.饲料投入4 d厂商");
