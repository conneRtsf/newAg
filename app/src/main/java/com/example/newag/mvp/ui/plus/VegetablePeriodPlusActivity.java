...
public class VegetablePeriodPlusActivity extends BaseActivity {
    @OnClick(R.id.commit)
    public void cl(){
    ...
    protected void baseConfigView() {
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(VegetablePeriodPlusActivity.this,  2, btnDate, calendar);;
            }
        });
            ...
            public void run() {
                try {
                    ...
                    for (Map.Entry<String, JsonArray> entry : map.entrySet()) {
                        ...
                        Log.e("pond11423: ", String.valueOf(pond));
                    ...
                    VegetablePeriodPlusActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            adapter = new ArrayAdapter<CharSequence>(VegetablePeriodPlusActivity.this,android.R.layout.simple_spinner_item, finalMidS);
                            produce.setAdapter(adapter);
                            produce.setOnItemSelectedListener(new VegetablePeriodPlusActivity.OnItemSelectedListenerImpl1());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
                ...
                try {
                    ...
                    VegetablePeriodPlusActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            plan.setOnItemSelectedListener(new VegetablePeriodPlusActivity.OnItemSelectedListenerImpl2());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
                ...
                try {
                    ...
                    VegetablePeriodPlusActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            nameId.setOnItemSelectedListener(new VegetablePeriodPlusActivity.OnItemSelectedListenerImpl3());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
    ...
    public void postSync(int A,String B,int C,String name1,String time) {
        ...
        if(time.equals(null)){
            Toast.makeText(VegetablePeriodPlusActivity.this, "时间不可为空", Toast.LENGTH_SHORT).show();
            return;
        }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                new Thread(() -> {
                    try {
                        ...
                        Toast.makeText(VegetablePeriodPlusActivity.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        if(jsonObject1.getString("msg").equals("插入成功")){
                            VegetablePeriodPlusActivity.this.finish();
                        }
                        Looper.loop();
