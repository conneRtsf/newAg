...
public class other_cost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cost_other);
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(other_cost.this,  2, btnDate, calendar);
            }
        });
        initText();//为原始数据添加数据
        ...
        ce1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(other_cost.this, people_cost.class);
...
//        dialogWindow.setWindowAnimations(R.style.dialogstyle); // 添加动画
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(other_cost.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(other_cost.this).inflate(R.layout.cost_other,null);
        ...
        View view2=LayoutInflater.from(other_cost.this).inflate(R.layout.popwindowdelete,null);
