...
public class FishSalesAccountingActivity extends BaseActivity {
    @OnClick(R.id.plus)
    void onClick1(View view) {
        Intent intent = new Intent();
        intent.setClass(FishSalesAccountingActivity.this, FishSalesAccountingPlusActivity.class);
        startActivity(intent);
    }
    @OnClick(R.id.ce2)
    void click1(){
        Intent intent = new Intent();
        intent.setClass(FishSalesAccountingActivity.this,VegetableSalesAccountingActivity.class);
        startActivity(intent);
        finish();
    }
    @BindView(R.id.root)
    ...
    protected void baseConfigView() {
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(FishSalesAccountingActivity.this,  2, btnDate, calendar);;
            }
        });
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View rootView;
                View view2=LayoutInflater.from(FishSalesAccountingActivity.this).inflate(R.layout.ppw_delete,null);
                ...
                rootView= LayoutInflater.from(FishSalesAccountingActivity.this).inflate(R.layout.activity_salesaccountingplus,null);
                ...
                button_cancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        data_1.clear();
                        postSync();
                        FishSalesAccountingActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                adapter.notifyDataSetChanged();
                            }
                                ...
                                public void run() {
                                    try {
                                        ...
                                        FishSalesAccountingActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(FishSalesAccountingActivity.this, fd,Toast.LENGTH_SHORT).show();
                                                adapter.notifyDataSetChanged();
                                            }
                                        });
        ...
        new DatePickerDialog(activity, themeResId, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                FishSalesAccountingActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FishSalesAccountingActivity.this, "刷新以重新获取全部数据", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void postSync() {
        ...
        call.enqueue(new Callback<SalesAccountingTranslation>() {
            ...
            public void onFailure(retrofit2.Call<SalesAccountingTranslation> call, Throwable throwable) {
                ...
                Toast.makeText(FishSalesAccountingActivity.this, "error", Toast.LENGTH_SHORT).show();
            }
        });
    }
