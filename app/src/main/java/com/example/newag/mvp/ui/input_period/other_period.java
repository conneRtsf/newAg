...
public class other_period extends AppCompatActivity {
    Button ce1;
    Button ce2;
    Button ce3;
    Button plus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(other_period.this,  2, btnDate, calendar);;
            }
        });
        initText();//为原始数据添加数据
        ...
        ce1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(other_period.this, fish_period.class);
        ...
        ce2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(other_period.this, vegetable_period.class);
                startActivity(intent);
                finish();
            }
        });
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(other_period.this, period_plus.class);
                startActivity(intent);
            }
        });
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(other_period.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(other_period.this).inflate(R.layout.period_other,null);
        ...
        View view2=LayoutInflater.from(other_period.this).inflate(R.layout.popwindowdelete,null);
