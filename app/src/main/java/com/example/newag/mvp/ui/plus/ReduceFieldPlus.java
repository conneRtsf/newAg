...
public class ReduceFieldPlus extends BaseActivity {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                new Thread(() -> {
                    try {
                        ...
                        Toast.makeText(ReduceFieldPlus.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        if(jsonObject1.getString("msg").equals("添加成功")){
                            Intent intent = new Intent();
                            intent.setClass(ReduceFieldPlus.this, ReduceAddActivity.class);
                            startActivity(intent);
                            ReduceFieldPlus.this.finish();
                        }
                        Looper.loop();
