...
public class CostPeoplePlusActivity extends BaseActivity {
    @BindView(R.id.name)
    EditText name;
    ...
    public void postSync() {
        ...
        paramsMap.put("weightUnit", "人");
        paramsMap.put("type", "people");
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                new Thread(() -> {
                    try {
                        ...
                        Toast.makeText(CostPeoplePlusActivity.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        if(jsonObject1.getString("msg").equals("添加成功")){
                            CostPeoplePlusActivity.this.finish();
                        }
                        Looper.loop();
