...
public class CostVegetablePlusActivity extends BaseActivity {
    @BindView(R.id.name)
    EditText name;
            ...
            public void run() {
                try {
                    ...
                    CostVegetablePlusActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            adapter = new ArrayAdapter<CharSequence>(CostVegetablePlusActivity.this,android.R.layout.simple_spinner_item, finalMidS);
                            ...
                            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                                ...
                                new Thread(() -> {
                                    try {
                                        ...
                                        Toast.makeText(CostVegetablePlusActivity.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                                        if (jsonObject1.getString("msg").equals("添加成功")) {
                                            CostVegetablePlusActivity.this.finish();
                                        }
                                        Looper.loop();
