...
import com.example.newag.mvp.ui.change.FeedCost;
import com.example.newag.mvp.ui.change.FishCost;
...
//        dialogWindow.setWindowAnimations(R.style.dialogstyle); // 添加动画
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(FishCostActivity.this).inflate(R.layout.pop_plusfishvegetable, null);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(FishCostActivity.this, FishCost.class);
