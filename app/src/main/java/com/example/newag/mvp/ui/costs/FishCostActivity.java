...
public class FishCostActivity extends BaseActivity {
    @OnClick(R.id.tb1)
    ...
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(FishCostActivity.this, EnergyCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    ...
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(FishCostActivity.this, CostFishPlusActivity.class);
        startActivity(intent);
    }
    ...
    protected void baseConfigView() {
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                rootView= LayoutInflater.from(FishCostActivity.this).inflate(R.layout.activity_costfish,null);
                ...
                button_cancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        data_1.clear();
                        postSync();
                        FishCostActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                adapter.notifyDataSetChanged();
                            }
                                ...
                                public void run() {
                                    try {
                                        ...
                                        FishCostActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(FishCostActivity.this, fd,Toast.LENGTH_SHORT).show();
                                                adapter.notifyDataSetChanged();
                                            }
                                        });
        ...
        new DatePickerDialog(activity, themeResId, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                FishCostActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FishCostActivity.this, "刷新以重新获取全部数据", Toast.LENGTH_SHORT).show();
                    }
                });
                OkHttpClient httpClient = new OkHttpClient.Builder()
