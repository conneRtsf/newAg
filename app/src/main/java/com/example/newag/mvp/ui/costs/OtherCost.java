...
public class OtherCost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ce3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(OtherCost.this, EnergyCost.class);
                startActivity(intent);
                finish();
            }
        });
...
//        dialogWindow.setWindowAnimations(R.style.dialogstyle); // 添加动画
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(OtherCost.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(OtherCost.this).inflate(R.layout.cost_other,null);
        ...
        View view2=LayoutInflater.from(OtherCost.this).inflate(R.layout.popwindowdelete,null);
