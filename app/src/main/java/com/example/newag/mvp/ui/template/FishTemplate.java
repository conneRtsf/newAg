...
public class FishTemplate extends AppCompatActivity {
    @OnClick(R.id.tb1)
    ...
    void onClick1(View view) {
        ...
        intent.setClass(FishTemplate.this, DrugTemplate.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(FishTemplate.this, FeedTemplate.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(FishTemplate.this, FishTemplate.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(FishTemplate.this, VegetableTemplate.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(FishTemplate.this, OtherTemplate.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(FishTemplate.this, TemplatePlus.class);
        startActivity(intent);
    }
    @BindView(R.id.root)
    DrawerLayout root;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_templatefish);
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(FishTemplate.this).inflate(R.layout.footer_batch,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(FishTemplate.this).inflate(R.layout.activity_templatefish,null);
        ...
        View view2=LayoutInflater.from(FishTemplate.this).inflate(R.layout.ppw_delete,null);
