...
import com.example.newag.mvp.ui.change.VegetableStorkChangeActivity;
import com.example.newag.mvp.ui.plus.StorkVegetablePlusActivity;
...
public class VegetableStockActivity extends BaseActivity {
    ...
    void onClick1(View view) {
        ...
        intent.setClass(VegetableStockActivity.this, DrugStockActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableStockActivity.this, FeedStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableStockActivity.this, FishStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableStockActivity.this, VegetableStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableStockActivity.this, OtherStockActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableStockActivity.this, StorkVegetablePlusActivity.class);
        startActivity(intent);
    }
    @BindView(R.id.root)
    DrawerLayout root;
    ...
    protected int layoutId() {
        return R.layout.activity_templatevegetable;
    }
    ...
    private void showPopWindow(AllText allText,int position) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(VegetableStockActivity.this, VegetableStorkChangeActivity.class);
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(VegetableStockActivity.this).inflate(R.layout.footer_batch,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(VegetableStockActivity.this).inflate(R.layout.activity_templatevegetable,null);
        ...
        View view2=LayoutInflater.from(VegetableStockActivity.this).inflate(R.layout.ppw_delete,null);
                        ...
                        public void run() {
                            try {
                                ...
                                VegetableStockActivity.this.runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(VegetableStockActivity.this, fd,Toast.LENGTH_SHORT).show();
                                        adapter.notifyDataSetChanged();
                                    }
                                });
