...
import com.example.newag.mvp.ui.plus.HarvestFishingPlusActivity;
...
public class HarvestFishingActivity extends BaseActivity {
    ...
    void click1(){
        Intent intent = new Intent();
        intent.setClass(HarvestFishingActivity.this, HarvestFishingActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    ...
    protected void baseConfigView() {
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(HarvestFishingActivity.this,  2, btnDate, calendar);;
            }
        });
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View rootView;
                View view2= LayoutInflater.from(HarvestFishingActivity.this).inflate(R.layout.ppw_delete,null);
                ...
                rootView= LayoutInflater.from(HarvestFishingActivity.this).inflate(R.layout.activity_harvest_fishing,null);
                ...
                button_cancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        data_1.clear();
                        postSync();
                        HarvestFishingActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                adapter.notifyDataSetChanged();
                            }
                                ...
                                public void run() {
                                    try {
                                        ...
                                        HarvestFishingActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(HarvestFishingActivity.this, fd,Toast.LENGTH_SHORT).show();
                                                adapter.notifyDataSetChanged();
                                            }
                                        });
    ...
    protected int layoutId() {
        return R.layout.activity_harvest_fishing;
    }
        ...
        new DatePickerDialog(activity, themeResId, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                HarvestFishingActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(HarvestFishingActivity.this, "刷新以重新获取全部数据", Toast.LENGTH_SHORT).show();
                    }
                });
