    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(energy_cost.this,  2, btnDate, calendar);
            }
        });
        initText();//为原始数据添加数据
        ...
        ce1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(energy_cost.this, people_cost.class);
...
//        dialogWindow.setWindowAnimations(R.style.dialogstyle); // 添加动画
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(energy_cost.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(energy_cost.this).inflate(R.layout.cost_energy,null);
        ...
        View view2=LayoutInflater.from(energy_cost.this).inflate(R.layout.popwindowdelete,null);
