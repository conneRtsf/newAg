...
public class drug_template extends AppCompatActivity {
    Button ce1;
    Button ce2;
    Button ce3;
    Button ce4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.template_drug);
        ...
        ce2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(drug_template.this, feed_template.class);
        ...
        ce3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(drug_template.this, fish_template.class);
                startActivity(intent);
                finish();
            }
        });
        ce4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(drug_template.this, vegetable_template.class);
                startActivity(intent);
                finish();
            }
        });
        ce5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(drug_template.this, other_template.class);
                startActivity(intent);
                finish();
            }
        });
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(drug_template.this, template_plus.class);
                startActivity(intent);
            }
        });
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(drug_template.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(drug_template.this).inflate(R.layout.template_drug,null);
        ...
        View view2=LayoutInflater.from(drug_template.this).inflate(R.layout.popwindowdelete,null);
