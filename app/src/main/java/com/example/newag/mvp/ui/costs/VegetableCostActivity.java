...
import com.example.newag.mvp.ui.plus.CostVegetablePlusActivity;
...
public class VegetableCostActivity extends BaseActivity {
    @OnClick(R.id.tb1)
    ...
    void onClick1(View view) {
        ...
        intent.setClass(VegetableCostActivity.this, PeopleCostActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableCostActivity.this, FeedCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableCostActivity.this, EnergyCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableCostActivity.this, FishCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableCostActivity.this, VegetableCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce6)
    void onClick6(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableCostActivity.this, OtherCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce7)
    void onClick7(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableCostActivity.this, AllCostActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableCostActivity.this, CostVegetablePlusActivity.class);
        startActivity(intent);
    }
    ...
    protected void baseConfigView() {
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(VegetableCostActivity.this,  2, btnDate, calendar);
            }
        });
    ...
    protected int layoutId() {
        return R.layout.activity_costvegetable;
    }
    ...
    public void showDatePickerDialog(Activity activity, int themeResId, Button bt, Calendar calendar) {
        ...
        new DatePickerDialog(activity, themeResId, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                VegetableCostActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(VegetableCostActivity.this, "刷新以重新获取全部数据", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(VegetableCostActivity.this).inflate(R.layout.footer_batch,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(VegetableCostActivity.this).inflate(R.layout.activity_costvegetable,null);
        ...
        View view2=LayoutInflater.from(VegetableCostActivity.this).inflate(R.layout.ppw_delete,null);
                            ...
                            public void run() {
                                try {
                                    ...
                                    VegetableCostActivity.this.runOnUiThread(new Runnable() {
                                        @Override
                                        public void run() {
                                            Toast.makeText(VegetableCostActivity.this, fd,Toast.LENGTH_SHORT).show();
                                        }
                                    });
