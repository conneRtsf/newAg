...
public class other_template extends AppCompatActivity {
    Button ce1;
    Button ce2;
    Button ce3;
    Button ce4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ce1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(other_template.this, drug_template.class);
        ...
        ce2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(other_template.this, feed_template.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ce3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(other_template.this, fish_template.class);
                startActivity(intent);
                finish();
            }
        });
        ce4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(other_template.this, vegetable_template.class);
                startActivity(intent);
                finish();
            }
        });
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(other_template.this, template_plus.class);
                startActivity(intent);
            }
        });
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(other_template.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(other_template.this).inflate(R.layout.template_other,null);
        ...
        View view2=LayoutInflater.from(other_template.this).inflate(R.layout.popwindowdelete,null);
