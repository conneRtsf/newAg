...
public class CostOtherPlusActivity extends BaseActivity {
    @BindView(R.id.name)
    EditText name;
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                new Thread(() -> {
                    try {
                        ...
                        Toast.makeText(CostOtherPlusActivity.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        if(jsonObject1.getString("msg").equals("添加成功")){
                            CostOtherPlusActivity.this.finish();
                        }
                        Looper.loop();
