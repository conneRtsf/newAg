...
public class VegetableTemplateActivity extends BaseActivity {
    @OnClick(R.id.tb1)
    ...
    void onClick1(View view) {
        ...
        intent.setClass(VegetableTemplateActivity.this, DrugTemplateActivity.class);
    ...
    void onClick2(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableTemplateActivity.this, FeedTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce3)
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableTemplateActivity.this, FishTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce4)
    void onClick4(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableTemplateActivity.this, VegetableTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.ce5)
    void onClick5(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableTemplateActivity.this, OtherTemplateActivity.class);
        startActivity(intent);
        finish();
    }
    @OnClick(R.id.plus)
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(VegetableTemplateActivity.this, TemplatePlus.class);
        startActivity(intent);
    }
    @BindView(R.id.root)
    DrawerLayout root;
    ...
    private void showPopWindow(AllText allText,int position) {
        View view = LayoutInflater.from(VegetableTemplateActivity.this).inflate(R.layout.pop_plustemplate, null);
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(VegetableTemplateActivity.this).inflate(R.layout.footer_batch,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(VegetableTemplateActivity.this).inflate(R.layout.activity_templatevegetable,null);
        ...
        View view2=LayoutInflater.from(VegetableTemplateActivity.this).inflate(R.layout.ppw_delete,null);
