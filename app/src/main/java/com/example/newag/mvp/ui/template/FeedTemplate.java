...
public class FeedTemplate extends AppCompatActivity {
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(FeedTemplate.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(FeedTemplate.this).inflate(R.layout.template_feed,null);
        ...
        View view2=LayoutInflater.from(FeedTemplate.this).inflate(R.layout.popwindowdelete,null);
