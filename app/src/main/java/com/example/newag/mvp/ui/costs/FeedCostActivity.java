...
import com.example.newag.mvp.ui.plus.CostFeedPlusActivity;
...
public class FeedCostActivity extends BaseActivity {
    ...
    void onClick3(View view) {
        Intent intent = new Intent();
        intent.setClass(FeedCostActivity.this, EnergyCostActivity.class);
        startActivity(intent);
        finish();
    }
    @SuppressLint("NonConstantResourceId")
    ...
    void onClick11(View view) {
        Intent intent = new Intent();
        intent.setClass(FeedCostActivity.this, CostFeedPlusActivity.class);
        startActivity(intent);
    }
    ...
    protected void baseConfigView() {
        ...
        Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                rootView= LayoutInflater.from(FeedCostActivity.this).inflate(R.layout.activity_costfeed,null);
                                ...
                                public void run() {
                                    try {
                                        ...
                                        FeedCostActivity.this.runOnUiThread(new Runnable() {
                                            @Override
                                            public void run() {
                                                Toast.makeText(FeedCostActivity.this, fd,Toast.LENGTH_SHORT).show();
                                                adapter.notifyDataSetChanged();
                                            }
                                        });
    ...
    protected int layoutId() {
        return R.layout.activity_costfeed;
    }
        ...
        new DatePickerDialog(activity, themeResId, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                FeedCostActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(FeedCostActivity.this, "刷新以重新获取全部数据", Toast.LENGTH_SHORT).show();
                    }
                });
                OkHttpClient httpClient = new OkHttpClient.Builder()
