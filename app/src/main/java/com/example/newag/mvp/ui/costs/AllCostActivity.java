    ...
    public void showDatePickerDialog(Activity activity, int themeResId, Button bt, Calendar calendar) {
        ...
        new DatePickerDialog(activity, themeResId, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                AllCostActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(AllCostActivity.this, "刷新以重新获取全部数据", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void showPopWindow() {
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(AllCostActivity.this).inflate(R.layout.activity_costvegetable,null);
                        ...
                        public void run() {
                            try {
                                ...
                                AllCostActivity.this.runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(AllCostActivity.this, fd,Toast.LENGTH_SHORT).show();
                                    }
                                });
