...
public class ReduceFishPlus extends BaseActivity {
    ...
    protected int layoutId() {
        return R.layout.activity_plusreducefish;
    }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                new Thread(() -> {
                    try {
                        ...
                        Toast.makeText(ReduceFishPlus.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        if(jsonObject1.getString("msg").equals("添加成功")){
                            Intent intent = new Intent();
                            intent.setClass(ReduceFishPlus.this, ReduceAddActivity.class);
                            startActivity(intent);
                            ReduceFishPlus.this.finish();
                        }
                        Looper.loop();
