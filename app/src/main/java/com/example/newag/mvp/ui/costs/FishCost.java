...
//        dialogWindow.setWindowAnimations(R.style.dialogstyle); // 添加动画
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(FishCost.this).inflate(R.layout.footer_batch,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(FishCost.this).inflate(R.layout.activity_costfish,null);
        ...
        View view2=LayoutInflater.from(FishCost.this).inflate(R.layout.ppw_delete,null);
