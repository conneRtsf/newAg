...
public class FishCost extends AppCompatActivity {
    Button tb1;
    Button ce1;
    Button ce2;
    Button ce3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cost_fish);
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(FishCost.this,  2, btnDate, calendar);
            }
        });
        initText();//为原始数据添加数据
        ...
        ce1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(FishCost.this, PeopleCost.class);
        ...
        ce2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(FishCost.this, FeedCost.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ce3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(FishCost.this, EnergyCost.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ce5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(FishCost.this, VegetableCost.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ce6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(FishCost.this, OtherCost.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        ce7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(FishCost.this, AllCost.class);
                startActivity(intent);
                finish();
            }
        });
...
//        dialogWindow.setWindowAnimations(R.style.dialogstyle); // 添加动画
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(FishCost.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(FishCost.this).inflate(R.layout.cost_fish,null);
        ...
        View view2=LayoutInflater.from(FishCost.this).inflate(R.layout.popwindowdelete,null);
