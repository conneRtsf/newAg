...
public class feed_template extends AppCompatActivity {
    Button ce1;
    Button ce2;
    Button ce3;
    Button ce4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.template_feed);
        ...
        ce1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(feed_template.this, drug_template.class);
        ...
        ce3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(feed_template.this, fish_template.class);
                startActivity(intent);
                finish();
            }
        });
        ce4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(feed_template.this, vegetable_template.class);
                startActivity(intent);
                finish();
            }
        });
        ce5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(feed_template.this, other_template.class);
                startActivity(intent);
                finish();
            }
        });
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(feed_template.this, template_plus.class);
                startActivity(intent);
            }
        });
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(feed_template.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(feed_template.this).inflate(R.layout.template_feed,null);
        ...
        View view2=LayoutInflater.from(feed_template.this).inflate(R.layout.popwindowdelete,null);
