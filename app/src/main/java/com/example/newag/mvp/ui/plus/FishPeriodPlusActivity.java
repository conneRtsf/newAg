...
import com.example.newag.mvp.ui.costs.EnergyCostActivity;
...
public class FishPeriodPlusActivity extends BaseActivity {
    @OnClick(R.id.commit)
    public void cl(){
    ...
    protected void baseConfigView() {
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                showDatePickerDialog(FishPeriodPlusActivity.this,  2, btnDate, calendar);;
            }
        });
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    FishPeriodPlusActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            adapter = new ArrayAdapter<CharSequence>(FishPeriodPlusActivity.this,android.R.layout.simple_spinner_item, finalMidS);
                            produce.setAdapter(adapter);
                            produce.setOnItemSelectedListener(new FishPeriodPlusActivity.OnItemSelectedListenerImpl1());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
                ...
                try {
                    ...
                    FishPeriodPlusActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            plan.setOnItemSelectedListener(new FishPeriodPlusActivity.OnItemSelectedListenerImpl2());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
                ...
                try {
                    ...
                    FishPeriodPlusActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            nameId.setOnItemSelectedListener(new OnItemSelectedListenerImpl3());
                        }
                    });
                }catch (Exception e){
                    e.printStackTrace();
    ...
    public void postSync(int A,String B,int C,String name1,String time) {
        ...
        if(time.equals(null)){
            Toast.makeText(FishPeriodPlusActivity.this, "时间不可为空", Toast.LENGTH_SHORT).show();
        }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                new Thread(() -> {
                    try {
                        ...
                        Toast.makeText(FishPeriodPlusActivity.this, jsonObject1.getString("msg"), Toast.LENGTH_SHORT).show();
                        if(jsonObject1.getString("msg").equals("插入成功")){
                            FishPeriodPlusActivity.this.finish();
                        }
                        Looper.loop();
