...
public class fish_template extends AppCompatActivity {
    ...
    private void showPopWindow() {
        ...
        View view1= LayoutInflater.from(fish_template.this).inflate(R.layout.test_popupwindow,null);
        ...
        make_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View rootView= LayoutInflater.from(fish_template.this).inflate(R.layout.template_fish,null);
        ...
        View view2=LayoutInflater.from(fish_template.this).inflate(R.layout.popwindowdelete,null);
